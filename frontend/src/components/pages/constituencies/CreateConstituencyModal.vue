              ...
              <div>
                ...
                <div class="mt-3 text-center sm:mt-5">
                  <DialogTitle
                    ...
                    >Add New Constituency</DialogTitle
                  >
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      Fill in the details below to create a new constituency.
                    </p>
                  </div>
                </div>
              </div>
